...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set GPIO_LED_0_LS [ create_bd_port -dir O -from 0 -to 0 -type data GPIO_LED_0_LS ]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_ports GPIO_LED_0_LS] [get_bd_pins xlslice_0/Dout]
